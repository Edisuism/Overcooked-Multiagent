...
games['overcooked'] = Game(env_name='Overcooked',
  input_size=30, #state representation, 6x5 grid
  output_size=6, #actions, up,down,left,right,nothing,interact
  time_factor=0,
...
def makeOvercookedPolicy(filename):
  model = Model(games['overcooked']) 
